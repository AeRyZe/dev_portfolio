    ...
    return (
        <div id='contact-container'>
            ...
            <form action="post" id='contact-form'>
                ...
                <input type="text" name="contact-name" id='contact-name' placeholder='Votre nom et prénom' required='required' />
                <label htmlFor="contact-mail">Email</label>
                <input type="text" name="contact-mail" id='contact-mail' placeholder='Votre adresse mail' required='required' />
