    ...
    return (
        <div className='banner-container' id='banner-container'>
            ...
            <div className='banner-ui'>
                <FontAwesomeIcon id='banner-star-1' icon={faCircle} beatFade style={{ color: palette.white }} />
                ...
                <FontAwesomeIcon id='banner-star-7' icon={faCircle} beatFade style={{ color: palette.yellow }} />
